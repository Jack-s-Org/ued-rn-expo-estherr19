      ...
      >
        ...
        <View style={styles.container}>
            ...
            <View style={styles.buttonGroup}>
              ...
              >
                <ImageBackground
                  source={
                    selectedButton === 0
                      ? require("../assets/images/femaleChosen.png")
                      : require("../assets/images/femaleButton.png")
                  }
              ...
              >
                <ImageBackground
                  source={
                    selectedButton === 1
                      ? require("../assets/images/maleChosen.png")
                      : require("../assets/images/maleButton.png")
                  }
                  style={styles.buttonImage}
                />
              </TouchableOpacity>
              ...
              >
                <ImageBackground
                  source={
                    selectedButton === 2
                      ? require("../assets/images/neutralChosen.png")
                      : require("../assets/images/neutralButton.png")
                  }
                  style={styles.buttonImage}
                />
              </TouchableOpacity>
          ...
          <View style={styles.textButtonContainer}>
            <GradientButton
              onPress={() => {
                navigation.replace("LoginScreen4");
              }}
            >
