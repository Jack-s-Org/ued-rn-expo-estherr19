      ...
      >
        <View style={styles.textContainer}>
          <View style={styles.titleText}>
            <Text style={styles.welcomeText}>Seamless</Text>
            <Text style={styles.welcomeText}>Workout Flow</Text>
          </View>

          <Text style={styles.detailsText}>
            Experience seamless workouts with JustFit. Our Music Sync
            automatically adjusts music based on your movements, keeping you
            uninterrupted.
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  gradientButton: {
    ...
    marginTop: 10, // Adjust to move the button vertically
